...
Original file is located at
    https://colab.research.google.com/drive/1H_Pjp_-tFKuZfaOv7fT-LoBeMm8GGDlQ
"""
...
#then add one or more Dense layers on top. CIFAR has 10 output classes, so you use a final Dense layer with 10 outputs and a softmax activation.
